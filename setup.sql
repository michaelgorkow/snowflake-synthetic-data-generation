...
CREATE SCHEMA IF NOT EXISTS AI_DEVELOPMENT.SYNTHETIC_DATA_GENERATION;

-- Create Notebooks
CREATE NOTEBOOK SYNTHETIC_DATA_GENERATION_AUDIO
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SYNTHETIC_DATA_GENERATION/branches/main' 
        ...
        MAIN_FILE = 'src/notebooks/audio_demo.ipynb';
