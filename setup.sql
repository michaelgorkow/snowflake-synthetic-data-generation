...
CREATE OR REPLACE SCHEMA AI_DEVELOPMENT.SYNTHETIC_DATA_GENERATION;
...
CREATE OR REPLACE NOTEBOOK SYNTHETIC_DATA_GENERATION_AUDIO
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SYNTHETIC_DATA_GENERATION/branches/main/examples' 
...
CREATE OR REPLACE NOTEBOOK food_beverage_call_center_recordings
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SYNTHETIC_DATA_GENERATION/branches/main/misc' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_GPU'
        RUNTIME_NAME = 'SYSTEM$GPU_RUNTIME'
        MAIN_FILE = 'food_beverage_call_center_recordings.ipynb';
